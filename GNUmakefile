...
SRCOBJ = allmain.o alloc.o apply.o artifact.o astar.o attrib.o ball.o bones.o	\
         ...
         sp_lev.o spell.o steal.o steed.o string.o teleport.o testing.o \
...
ifeq ($(CHAOS),1)
SRCOBJ += chaos_protocol.o chaos_io.o chaos_engine.o chaos_presentation.o chaos_lua.o chaos_next_use.o chaos_next_use_admission.o chaos_next_use_runtime.o chaos_next_use_journal.o chaos_next_use_io.o chaos_next_use_safe.o chaos_shadow.o chaos_haunt.o chaos_curio.o
...
chaos_next_use_journal.o: src/chaos_next_use_journal.c include/chaos_next_use_journal.h include/chaos_next_use_runtime.h
