...
#define CHAOS_MUTATION_ROWS(X) \
    X(CHAOS_AMBIENT, "ambient", 1, 1, 3, 0, 0, 1, -1, 0, 0, CHAOS_RULE_NONE) \
    X(CHAOS_WARD, "ward_efficacy", 4, 50, 50, 1, 50, 2, 80, 0, 1, CHAOS_RULE_HALVE) \
    X(CHAOS_HUNGER, "hunger_rate", 3, 2, 2, 1, 50, 3, 90, 1, 1, CHAOS_RULE_DOUBLE)
